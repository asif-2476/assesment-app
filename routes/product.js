...
route.post('/createproduct',body('name').notEmpty().withMessage('Name is required'),body('price').notEmpty().withMessage('Price is required'),body('category').notEmpty().withMessage('category is required'),authAdmin,fileupload,ProductController.createproduct);
